...
## Sound Tracker:
<img src="SoundTracker/pictures/soundTracker.gif" width=350>

Uses embedded programming and signal processing to calculate the direction of a sound and then point in that direction

[Click here to learn about the Sound Tracker project](./SoundTracker/)
...
## Fruit Store
<img src="./FruitStoreWebApp/fruitStoreFrontend/pictures/frontEndPic.png" width=800>

Allows users to create an account, sign in, and add to their shopping carts.
...
One of my first projects. Uses vanilla Javascript and HTML to showcase the work of a graphic designer.
